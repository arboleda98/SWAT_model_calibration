...
class SwatModel(object):
    ...
    def __init__(self):
        ...
        self.swat_exec = 'swat670_static.exe'
    ...
    def initFromTxtInOut(txtInOut, copy=None, target_dir=None, swat_version='2012', force=False, version_swat=1):
    ...
    # FACTORY method, no self
    # pylint: disable=no-self-argument
    def loadModelFromDirectory(target_dir, version_swat=1):
